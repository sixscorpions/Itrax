...
public class SpinnerDialogWorkBenchAdapter extends ArrayAdapter<String> {

    private List<String> spinnerModel;
    private LayoutInflater inflater;
    private BaseActivity parent;

    public SpinnerDialogWorkBenchAdapter(BaseActivity context, int textViewResourceId,
    ...
    public View getView(int position, View convertView, @NonNull ViewGroup view) {
        ViewHolder holder;
        if (convertView == null) {
            convertView = inflater.inflate(R.layout.layout_include_dialog_workbench_header, null);
